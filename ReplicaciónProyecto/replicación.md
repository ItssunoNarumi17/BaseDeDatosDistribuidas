...
**Instruccion**. Para este ejercicio se realizo una creación de una base de datos, de 
la cual se realizo este ejercicio.
...
La informacion para la *BD* se obtuvo mediante una explicación o platica que se tuvo con
el docente simulando un caso real de una consulta para la realización de un *SGDB* donde
